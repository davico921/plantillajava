...
public class User {
	...
	public User(String emplid, String last_name, String second_last_name, String first_name, String birthdate,
	...
	public String toString() {
		return "User [emplid=" + emplid + ", last_name=" + last_name + ", second_last_name=" + second_last_name
